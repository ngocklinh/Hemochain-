<nav>
    <div class="ver-nav-container">
        ...
        <a href="./hospital_db.php" class="ver-nav-item"> <i class="fa-solid fa-house-medical-circle-check"></i> <span>Hospitals</span> </a>
        <a href="./contact_db.php" class="ver-nav-item"> <i class="fa-solid fa-address-book"></i> <span>Contacts</span> </a>
    </div>
</nav>
